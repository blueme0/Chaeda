...
interface TextbookService {
    ...
    suspend fun postTextbookUploaded(requestTextbook: RequestTextbookDto): ResponseBody

    @POST("/textbook/presigned-url")
    suspend fun getPresignedUrlForTextbook(requestTextbook: RequestTextbookDto): ResponsePresignedTextbookDto
}